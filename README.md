...
`shf4` -> `4d6 t5 f1` Shadowrun 3rd/4th edition. The number is the number of dice to roll. To make them explode, simply use the explosion command like normal, i.e., `shf4 e`.
